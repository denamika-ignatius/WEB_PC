...
(function (global) {
    ...
    crypto.Blowfish = new function () {
        ...
        this.encryptPacket = function (/* string */rawPacket) {
            // summary:
            //    encrypts plaintext using key; allows user to specify output type and cipher mode via keyword object "ao"

            //var plaintext_current = new TextDecoder.TextDecoder('utf-8').decode(rawPacket);
            var plaintext = String.fromCharCode.apply(null,rawPacket);
            var key = "!@#$%^&*()ZXCVBN";
            var out = 3;
            var mode = 1;
        ...
        this.setIV("TRUStrus", crypto.outputTypes.String);
    }();
